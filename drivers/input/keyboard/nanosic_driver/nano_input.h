...
static unsigned char HID_TouchReportDescriptor[] = {
	...
	0x09,
	0x05, // Usage (0x05:Touch Pad; 0x04:Touch Screen)
	0xA1,
	...
	0x00, //     Logical Minimum (0)
	0x26,
	(TOUCH_PAD_X_SIZE_DESC & 0xff),
	((TOUCH_PAD_X_SIZE_DESC >> 8) & 0xff), //     Logical Maximum (3203)
	0x75,
	0x10, //     Report Size (16)
	0x55,
	0x0D, //     Uint Exponent(-3)
	0x65,
	0x13, //     Unit(Inch,Englinear)
	0x09,
	0x30, //     Usage (X)
	0x35,
	0x00, //     Physical Minimum (0)
	0x46,
	(MI_DISPLAY_X_SIZE_DESC & 0xff),
	...
	0x31, //     Usage (Y)
	0x26,
	(TOUCH_PAD_Y_SIZE_DESC & 0xff),
	((TOUCH_PAD_Y_SIZE_DESC >> 8) & 0xff), //     Logical Maximum (1884)
	0x46,
	(MI_DISPLAY_Y_SIZE_DESC & 0xff),
	...
	0x02, //   Input (Data,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
	0x09,
	0x55, //   Usage (Contact Ouunt Maximum)
	0xb1,
