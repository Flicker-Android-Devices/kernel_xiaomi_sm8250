...
enum apdo_max_power {
	APDO_MAX_30W =
		30, // J2 G7A F4 and some old projects use 30W pps charger
	APDO_MAX_33W = 33, // most 33W project use 33w pps charger
	APDO_MAX_40W = 40, // only F1X use 40w pps charger
	APDO_MAX_50W =
		50, // only j1(cmi project) use 50W pps(device support maxium 50w)
	APDO_MAX_55W = 55, // K2 K9B use 55w pps charger
	APDO_MAX_65W =
		65, //we have 65w pps which for j1(cmi), and also used for 120w(67w works in 65w)
	APDO_MAX_67W =
		67, //most useage now for dual charge pumps projects such as L3 L1 L1A L18
...
int smblib_set_prop_input_suspend(struct smb_charger *chg,
				  const union power_supply_propval *val);
int smblib_set_prop_battery_input_suspend(
...
int smblib_set_prop_system_temp_level(struct smb_charger *chg,
				      const union power_supply_propval *val);
int smblib_set_prop_input_current_limited(
	struct smb_charger *chg, const union power_supply_propval *val);
...
int smblib_get_prop_usb_voltage_max_design(struct smb_charger *chg,
					   union power_supply_propval *val);
int smblib_set_prop_usb_voltage_max_limit(
	struct smb_charger *chg, const union power_supply_propval *val);
...
int smblib_set_prop_battery_charging_enabled(
	struct smb_charger *chg, const union power_supply_propval *val);
int smblib_set_prop_smart_battery_enabled(
	struct smb_charger *chg, const union power_supply_propval *val);
