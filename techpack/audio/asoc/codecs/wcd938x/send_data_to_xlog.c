...
char wcd938x_msg_format[] =
	"{\"name\":\"mbhc_impedance\",\"audio_event\":{\"mbhc_impedance_left\":\"%d\",\"mbhc_impedance_right\":\"%d\"},\"dgt\":\"null\",\"audio_ext\":\"null\" }";
...
int xlog_wcd938x_format_msg_int(char *msg, const unsigned int zl,
