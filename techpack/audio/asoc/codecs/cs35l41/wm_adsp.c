	...
	switch(dsp->fw) {
		...
		case WM_ADSP_FW_SPK_PROT:
			if (dsp->component->name_prefix) {
				...
				//for ultrasonic
#if defined(CONFIG_TARGET_PRODUCT_APOLLO) || defined(CONFIG_TARGET_PRODUCT_CAS) || defined (CONFIG_TARGET_PRODUCT_ALIOTH) || defined (CONFIG_TARGET_PRODUCT_PSYCHE) || defined (CONFIG_TARGET_PRODUCT_THYME)
